...
{
    public partial class FromPrintDiemLTC : DevExpress.XtraEditors.XtraForm
    {
        private MonHocDAL monHocDAL;
        private LopTinChiDAL lopTinChiDAL;
        private UcReportDiemLTC ucReportDiemLTC = new UcReportDiemLTC();
        public FromPrintDiemLTC()
        {
            InitializeComponent();
